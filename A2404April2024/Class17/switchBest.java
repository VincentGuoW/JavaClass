...
public class switchBest {
    ...
    public static void main(String[] args) {
         ...
         * switch (inputNumber) {
         * case 1:
         * //if this is true and the result is the same as follow, we only need one
         * result.
         * case 2:
         * // if true, move done
         * case 3:
         ...
         * }
         * 
         * switch (inputNumber) {// arrow form will not work with break, cus it inluce
         * break inside
         * case 1->{}
         * case 2->{}
         ...
         * }
         * switch (inputNumber) {
         * //just for fun, this is not workin cus arrow come with break even without
         * braces
